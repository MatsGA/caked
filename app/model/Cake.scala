...
object Cake {
  ...
  new Cake("Super duper megagood cake", "images/cake1.jpg", "250 NOK") (
    <p><strong>The perfect cake for special occasions.</strong></p>
    <p>Popular amongst:</p>
    <ul>
      <li>Children</li>
      <li>Cats</li>
    ...
    <p><strong>Can easily be enjoyed alone, keeps in the <abbr title="refrigurator">fridge</abbr> for 5 years!</strong></p>
    <p><small>I take no responsibility for ingesting food that has gone bad</small></p>
  ),
    new Cake("Great berry cake", "images/cake2.jpg", "150,-") (
      <p><strong>Enjoy it on a summer day!</strong> </p>
    ...
    new Cake("Children crazy cake", "images/cake3.jpg", "350,-") (
     <p><strong>Get your child somethign special for his or her birthday.</strong></p>
